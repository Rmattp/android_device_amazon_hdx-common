...
$(KBUILD_MODULE): kbuild_out := $(TARGET_OUT_INTERMEDIATES)/../../$(LOCAL_PATH)/$(LOCAL_MODULE_KBUILD_NAME)
...
$(KBUILD_TARGET): $(TARGET_PREBUILT_INT_KERNEL)
	...
	$(MAKE) -C $(TARGET_KERNEL_SOURCE) M=../../../$(local_path) O=$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=$(KERNEL_TOOLCHAIN_PREFIX) modules $(kbuild_options)
